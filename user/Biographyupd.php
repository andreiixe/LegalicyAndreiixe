...
if (isset($_POST["submit"])) {
    ...
    $statement = mysqli_prepare($conn, "UPDATE tb_user SET biography = ? WHERE id = ?");
    mysqli_stmt_bind_param($statement, "si", $biography, $_SESSION['id']);
...
<html>
    <head>
        <title>Legalicy Andreiixe | Update Biography</title>
