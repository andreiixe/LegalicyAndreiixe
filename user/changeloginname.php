...
if (!empty($_SESSION["id"])) {
    ...
    if (isset($_POST["username"])) {
        $newUsername = mysqli_real_escape_string($conn, $_POST["username"]); // Escape the variable
        $updateStatement = mysqli_prepare($conn, "UPDATE tb_user SET username = ? WHERE id = ?");
        mysqli_stmt_bind_param($updateStatement, "si", $newUsername, $id);
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="415">
                            <tbody>
                                ...
                                <p>
                                    ...
                                    [<a href="changeusername">Edit Name</a>]
